...
var locateMeBtn = document.querySelector(".js-locate");
var output = document.querySelector(".js-output");

var createMapImage = function createMapImage(lat, lng) {
    var imageURL = "https://maps.googleapis.com/maps/api/staticmap?center=" + lat + "," + lng + "&size=400x400&zoom=15";
    var image = new Image();
    image.src = imageURL;
    output.appendChild(image);
};

var handleGeoError = function handleGeoError() {
    output.innerHTML = "<h2>Can't locate you</h2>";
};

var handleGeoSuccess = function handleGeoSuccess(position) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '5488' + '/');
...
//# sourceMappingURL=/src.88828fa1.map